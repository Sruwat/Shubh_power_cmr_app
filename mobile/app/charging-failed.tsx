...
export default function ChargingFailed() {
  return (
    <FxScreen>
      <BackHeader title="Charging Failed" onBack={() => router.back()} />
      ...
      <FxCard style={{ backgroundColor: "#fff2f0" }}><Text style={{ color: fx.red, fontWeight: "900" }}>Rescue Mode Active</Text><Text style={{ color: fx.muted }}>If this issue persists, our field team is notified automatically.</Text></FxCard>
    </FxScreen>
  );
}
