...
import { AppDrawerOverlay, AppDrawerProvider } from "@/components/ShubhShell";
        ...
        <QueryClientProvider client={queryClient}>
          <AppDrawerProvider>
            <Stack screenOptions={{ headerShown: false }}>
              ...
              <Stack.Screen name="queuepass" />
              <Stack.Screen name="onebill" />
              <Stack.Screen name="rescue" />
              <Stack.Screen name="trip-plan" />
              <Stack.Screen name="offline-access" />
